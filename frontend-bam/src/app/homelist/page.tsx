...
export default function Home() {
    ...
    const fetchData = async () => {
        try {
            ...
            if (params.toString()) {
                ...
                fullURL = `https://bam-backend.progressio.tech/house/search?${params.toString()}`;
            } else {
                // ถ้าไม่มี params ใช้ API หลัก
                fullURL = "https://bam-backend.progressio.tech/house/";
    ...
    const handleSearch = async () => {
        try {
            ...
            const response = await axios.get(`https://bam-backend.progressio.tech/house/search?${params.toString()}`);
