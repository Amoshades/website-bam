...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    try {
      const response = await fetch('https://bam-backend.progressio.tech/auth/login', {
        method: 'POST',
        headers: {
    ...
    <div>
      ...
      <div className="w-full h-[799px] bg-white flex flex-row items-center">
        <div className="w-[460px] h-[478px] border m-auto flex flex-col gap-5 border-black rounded-3xl p-[30px]">
          ...
          <a href='https://bam.progressio.tech/register' className="text-xl font-black text-main-color text-center font-line-bold">สมัครสมาชิก</a>
        </div>
      </div>
      <Footer />
    </div>
